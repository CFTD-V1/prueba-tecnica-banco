...
public record ClienteRequest(
        ...
        @NotBlank(message = "El número de identificación es obligatorio") @Size(max = 20, message = "El número de identificación no puede superar 20 caracteres") String numeroIdentificacion,
